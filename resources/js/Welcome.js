            ...
            <div className="antialiased">
                <div
                    ...
                    <div className="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                        <a href="/login" className="text-sm text-gray-700 dark:text-gray-500 underline">Log
                            in</a>
                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2">
                                <div className="p-6">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4 text-lg leading-7 font-semibold"><a
                                            href="https://laravel.com/docs"
                                            className="underline text-gray-900 dark:text-white">Documentation</a></div>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4 text-lg leading-7 font-semibold"><a
                                            ...
                                            className="underline text-gray-900 dark:text-white">Laracasts</a></div>
                                    </div>
                                ...
                                <div className="p-6 border-t border-gray-200 dark:border-gray-700">
                                    <div className="flex items-center">
                                        ...
                                        <div className="ml-4 text-lg leading-7 font-semibold"><a
                                            ...
                                            className="underline text-gray-900 dark:text-white">Laravel News</a></div>
                                    </div>
                                ...
                                <div className="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                                    <div className="flex items-center">
                                        ...
                                        <div
                                            className="ml-4 text-lg leading-7 font-semibold text-gray-900 dark:text-white">Vibrant
                                            Ecosystem
                                        </div>
                                    </div>
                                    ...
                                    <div className="ml-12">
                                        <div className="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                            ...
                                            href="https://forge.laravel.com" className="underline">Forge</a>, <a
                                            href="https://vapor.laravel.com" className="underline">Vapor</a>, <a
                                            href="https://nova.laravel.com" className="underline">Nova</a>, and <a
                                            href="https://envoyer.io" className="underline">Envoyer</a> help you take
                                            your projects to the next level. Pair them with powerful open source
                                            libraries like <a href="https://laravel.com/docs/billing"
                                                              className="underline">Cashier</a>, <a
                                            href="https://laravel.com/docs/dusk" className="underline">Dusk</a>, <a
                                            href="https://laravel.com/docs/broadcasting"
                                            className="underline">Echo</a>, <a href="https://laravel.com/docs/horizon"
                                                                               className="underline">Horizon</a>, <a
                                            href="https://laravel.com/docs/sanctum"
                                            className="underline">Sanctum</a>, <a
                                            href="https://laravel.com/docs/telescope"
                                            className="underline">Telescope</a>, and more.
                                        </div>
                                    </div>
                                </div>
                            </div>
